...
if (!isset($_REQUEST['informeData'])) {
    ...
    if(!isset($_REQUEST['pdf2'])){
        ...
        if(isset($informeData['fecha1'])){
            $fecha = $informeData['fecha1']." Hasta ". $informeData['fecha2'];
        }else{
            $fecha = $informeData['fecha'];
        ...
        foreach ($ventas as $venta) {
            $dataVentas[] = array(
                'id' => $venta['id'],
                'fecha' => $venta['fecha'],
                'totalNeto' => $venta['total_ganancia'],
                'totalBruto' => $venta['total_bruto']
            );
        }
        $dataCompras = [];
        foreach ($compras as $compra) {
        ...
        $pdf->Output("informe_$fecha.pdf", 'I'); 
