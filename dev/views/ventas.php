            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <button class="btn_editar" data-id="<?php echo $fila->id?>" data-accion1="obtenerVenta"data-accion2="editarVenta" data-url="../../dev/modal/editarVenta.html">Editar</button></td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
