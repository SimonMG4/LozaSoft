...
<body class="productos_body">
    ...
    <main class="productos_main">
        <div>
            <button class="btn_agregar" data-url="../../dev/modal/agregarVenta.html">Agregar</button>
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <button class="btn_editar" data-id="<?php echo $fila->id?>" data-accion1="obtenerVenta"data-accion2="editarVenta" data-url="../../dev/modal/editarCompra.html">Editar</button></td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
